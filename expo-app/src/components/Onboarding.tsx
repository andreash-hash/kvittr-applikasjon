...
function Headline({ title, italic, size = 40 }: {
  title: [string, string]; italic: string; size?: number;
}) {
          ...
          return (
            <Text key={j} style={isItalic ? {
              fontFamily: Platform.select({
                ios: 'Times New Roman', android: 'serif',
              }),
              fontStyle: 'italic',
              fontWeight: '400',
...
function SpecReceipts() {
  const Row = ({ shop, prod, amt, badge, badgeColor }: any) => (
    <View style={{
      ...
      {badge ? (
        <View style={{
          backgroundColor: badgeColor, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 99,
        }}>
    ...
    <Glass style={{ width: 280, alignItems: 'center', padding: 20, gap: 14 }}>
      ...
      <View style={{ flexDirection: 'row', gap: 10 }}>
        <View style={{
          ...
          <Text style={{ color: '#fff', fontSize: 20, fontWeight: '800', letterSpacing: -0.5 }}>2 år</Text>
          <Text style={{ color: 'rgba(255,255,255,0.75)', fontSize: 10 }}>Standard</Text>
        </View>
        <View style={{
          backgroundColor: 'rgba(255,255,255,0.12)',
          paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12,
          ...
          <Text style={{ color: '#fff', fontSize: 20, fontWeight: '800', letterSpacing: -0.5 }}>5 år</Text>
          <Text style={{ color: 'rgba(255,255,255,0.75)', fontSize: 10 }}>Varige varer</Text>
        </View>
      </View>
    </Glass>
  );
          ...
          <View style={{ flex: 1 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={{ color: '#fff', fontSize: 10, fontWeight: '700',
                textTransform: 'uppercase', letterSpacing: 0.5 }}>Kvittr</Text>
...
const styles = StyleSheet.create({
  ...
  primaryBtnText: {
    color: COLORS.charcoal, fontSize: 16, fontWeight: '700', letterSpacing: -0.1,
  },
  secondaryBtn: {
    height: 48,
    backgroundColor: 'rgba(255,255,255,0.12)',
